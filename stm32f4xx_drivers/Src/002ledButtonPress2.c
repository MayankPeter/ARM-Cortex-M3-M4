...
int main()
{
    ...
    while(1)
    {
    	if(GPIO_ReadFromInputPin(GPIOB, GPIO_PIN_NO_12) == BTN_PRESSED)
    	{
    		...
    		GPIO_WriteToOutputPin(GPIOA, GPIO_PIN_NO_8, ENABLE);
    	}
    	else
    	{
    		GPIO_WriteToOutputPin(GPIOA, GPIO_PIN_NO_8, DISABLE);
    	}
    }
